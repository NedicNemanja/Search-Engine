...
_DEPS = Arguments.h ErrorCodes.h FileMapping.h StringManipulation.h ReallocDocument.h
#pattern matching from  _DEPS to include directory
DEPS = $(patsubst %,$(INCLUDE_DIR)/%,$(_DEPS))

_OBJ = main.o Arguments.o FileMapping.o StringManipulation.o ReallocDocument.o
